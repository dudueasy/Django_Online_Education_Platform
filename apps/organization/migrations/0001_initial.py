# -*- coding: utf-8 -*-
# Generated by Django 1.9.8 on 2018-01-18 15:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='\u6dfb\u52a0\u65f6\u95f4')),
                ('category', models.CharField(choices=[('public', 'public'), ('private', 'private'), ('personal', 'personal')], default='public', max_length=100, verbose_name='\u673a\u6784\u7c7b\u522b')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('click_num', models.IntegerField(default=0, verbose_name='\u70b9\u51fb\u6570')),
                ('fav_num', models.IntegerField(default=0, verbose_name='\u6536\u85cf\u6570')),
                ('image', models.ImageField(upload_to='org/teacher/%Y/%m', verbose_name='\u5934\u50cf')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='\u6dfb\u52a0\u65f6\u95f4')),
